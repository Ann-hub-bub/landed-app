function payOpen(e) {
  ...
  setTimeout(function() { document.getElementById('payPhone').focus(); }, 300);
}
...
function paySubmit() {
  ...
  if (!phone) { document.getElementById('payPhone').focus(); return; }
  ...
  <div class="pay-box">
    ...
    <div class="pay-screen active" id="payForm">
      ...
      <div class="pay-field">
        ...
        <input type="tel" id="payPhone" placeholder="+1 (555) 000-0000" autocomplete="tel" />
      </div>
      <button class="pay-submit" onclick="paySubmit()">Complete purchase &nbsp;→</button>
